    ...
    <div>
      ...
      <div className="home-body">
        <header>
          ...
          <nav>
            <Link to="/Destination" style={{ background: "#fff", padding: "6px 12px", borderRadius: "20px" }}>Destinations</Link>
            <Link to="/Hotel" style={{ background: "#fff", padding: "6px 12px", borderRadius: "20px" }}>Hotels</Link>
            <Link to="/About" style={{ background: "#fff", padding: "6px 12px", borderRadius: "20px" }}>About Us</Link>
            <Link to="/Contact" style={{ background: "#fff", padding: "6px 12px", borderRadius: "20px" }}>Contact</Link>
          </nav>
